...
function NavTab({ item, active }: { item: AppNavItem; active: boolean }) {
  return (
    <Link
      ...
      className={cn(
        "flex h-full flex-1 flex-col items-center justify-center gap-1 rounded-lg text-[0.625rem] font-medium transition-colors",
...
/**
 * Mobile primary navigation. Five slots with Add Meal raised in the centre —
 * the action the whole product exists for.
 */
export function AppBottomNav() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-lg items-stretch gap-1 px-2 pb-safe">
